...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    eprintln!("SERVER_PORT: {:?}", std::env::var("SERVER_PORT"));
    eprintln!("SURREAL_URL: {:?}", std::env::var("SURREAL_URL"));
    ...
    let app = Router::new()
        ...
        .route("/api/permit-docs/:doc_id", get(site::get_site_permit_doc_by_id).delete(site::delete_site_permit_doc))
        .route("/api/permit-docs/:doc_id/preview", get(site::get_site_permit_doc_preview))
        // Site Issue routes
    ...
    eprintln!("🚀 Server starting on http://{}", addr);
    eprintln!("📝 Available endpoints:");
    eprintln!("  GET    /api/health");
    eprintln!("\n🔐 Auth & User Management:");
    eprintln!("  POST   /api/auth/register");
    eprintln!("  POST   /api/auth/login");
    eprintln!("  GET    /api/users");
    eprintln!("  GET    /api/users/:user_id");
    eprintln!("  PUT    /api/users/:user_id");
    eprintln!("  DELETE /api/users/:user_id");
    eprintln!("\n📊 Projects:");
    eprintln!("  POST   /api/projects");
    eprintln!("  GET    /api/projects");
    eprintln!("  GET    /api/projects/:id");
    eprintln!("  PUT    /api/projects/:id");
    eprintln!("  DELETE /api/projects/:id");
    eprintln!("\n🏗️  Sites:");
    eprintln!("  POST   /api/sites");
    eprintln!("  GET    /api/sites");
    eprintln!("  GET    /api/sites/project/:project_id");
    eprintln!("  GET    /api/sites/type          (Filter by type)");
    eprintln!("  GET    /api/sites/category/:cat (Filter by category)");
    eprintln!("\n👥 People:");
    eprintln!("  POST   /api/people");
    eprintln!("  GET    /api/people");
    eprintln!("  GET    /api/people/:id");
    eprintln!("  PUT    /api/people/:id");
    eprintln!("  DELETE /api/people/:id");
    eprintln!("  POST   /api/people/upload  (Excel upload)");
    eprintln!("\n👥 Teams:");
    eprintln!("  POST   /api/teams/upload  (Excel upload)");
    eprintln!("\n💰 Costs:");
    eprintln!("  POST   /api/costs");
    eprintln!("  GET    /api/costs");
    eprintln!("  GET    /api/costs/project/:project_id");
    eprintln!("  GET    /api/costs/site/:site_id");
    eprintln!("  POST   /api/costs/:cost_id/approve");
    eprintln!("\n📦 Materials:");
    eprintln!("  POST   /api/materials");
    eprintln!("  GET    /api/materials");
    eprintln!("  GET    /api/materials/project/:project_id");
    eprintln!("  GET    /api/materials/site/:site_id");
    eprintln!("\n🌍 Areas & Regions:");
    eprintln!("  POST   /api/areas");
    eprintln!("  GET    /api/areas");
    eprintln!("  POST   /api/regions");
    eprintln!("  GET    /api/regions");
    eprintln!("  GET    /api/regions/area/:area_id");
    eprintln!("\n📁 Files:");
    eprintln!("  POST   /api/project-files");
    eprintln!("  GET    /api/projects/:project_id/files");
    eprintln!("  DELETE /api/project-files/:file_id/delete");
    eprintln!("  POST   /api/site-files");
    eprintln!("  GET    /api/sites/:site_id/files");
    eprintln!("  DELETE /api/site-files/:file_id/delete");
    eprintln!("\n💵 Termins:");
    eprintln!("  POST   /api/termins");
    eprintln!("  GET    /api/termins");
    eprintln!("  GET    /api/termins/project/:project_id");
    eprintln!("  GET    /api/termins/site/:site_id");
    eprintln!("  GET    /api/termins/:termin_id");
    eprintln!("  PUT    /api/termins/:termin_id");
    eprintln!("  DELETE /api/termins/:termin_id");
    eprintln!("  POST   /api/termins/:termin_id/submit");
    eprintln!("  POST   /api/termins/:termin_id/review");
    eprintln!("  POST   /api/termins/:termin_id/approve");
    eprintln!("  POST   /api/termins/:termin_id/pay");
    eprintln!("  POST   /api/termin-files");
    eprintln!("  GET    /api/termins/:termin_id/files");
    eprintln!("  DELETE /api/termin-files/:file_id/delete");
    eprintln!("\n📝 Available roles for registration:");
    eprintln!("   - backoffice admin");
    eprintln!("   - management");
    eprintln!("   - team leader");
    eprintln!("   - finance");
    eprintln!("   - engineer");
    eprintln!("   - admin");
    eprintln!("   - direktur");
